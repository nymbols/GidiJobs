    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <table class="searchTable" width="100%">
                <tr>
                    <td>
                        <div style="width: 700px;">These options affect how GidiJobs formats numbers, dates, and time. <span style="font-weight:bold;">You (and your other site users) will need to log out and log back in for these settings to take effect.</span></div>
                        <br />
