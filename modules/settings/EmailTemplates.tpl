                                            ...
                                            <table>
                                                <tr style="vertical-align:top;">
                                                    ...
                                                    <div style="font-weight:bold;">Insert Formatting:</div>
                                                        ...
                                                        <?php generateInsertAtCursorLinkConditional($data, 'GidiJobs Candidate URL', '%CANDCATSURL%'); ?>
                                                        ...
                                                        <?php generateInsertAtCursorLinkConditional($data, 'GidiJobs Company URL', '%CLNTCATSURL%'); ?>
                                                        ...
                                                        <?php generateInsertAtCursorLinkConditional($data, 'GidiJobs Contact URL', '%CONTCATSURL%'); ?>
                                                        ...
                                                        <?php generateInsertAtCursorLinkConditional($data, 'GidiJobs Job Order URL', '%JBODCATSURL%'); ?>
                                                    </td>
                                                 </tr>
                                             </table>
                                        </td>
