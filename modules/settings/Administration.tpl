                        ...
                        <table class="searchTable" width="100%">
                            <tr>
                                <td width="230">
                                    ...
                                    <?php else: ?>
                                    <a href="http://www.gidijobs.co/?a=careerswebsite"><b>Careers Website</b></a>
                                    <?php endif; ?>
                                </td>
                                <td>
                        ...
                        <?php if ($this->systemAdministration): ?>
                            ...
                            <table class="searchTable" width="100%">
                                <!--<tr>
                                    ...
                                    <td>
                                        <i>Change how GidiJobs interacts with the server to schedule tasks.</i>
                                    </td>
                                </tr>-->
                                <tr>
                                    <td width="230">
                                    ...
                                    <td>
                                        Change how GidiJobs stores user passwords, and how users can retrieve them.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="230">
                                    ...
                                    <td>
                                        View information about this installation.
                                    </td>
                                </tr>
                            </table>
                        <?php endif; ?>
