            ...
            <table>
                <tr>
                    ...
                    <td valign="top" align="left" style="padding-left: 20px;">
                        ...
                        As a Professional member, you're entitled to the latest features and releases of GidiJobs,
                        helpful support services, and plug-ins to make finding and managing talent easier than ever.
                        <br /><br />
                        For more information on getting started and your Professional membership, please visit the official
                        Professional membership website at <a href="" target="_blank">www.gidijobs.co/<b>professional</b></a>.
                        From there, you'll find information about the latest new releases and all the tools and resources
                        available to you.
                        <br /><br />
                        <b>All the professional features in GidiJobs have been unlocked and are ready-to-use.</b>
                        <br /><br />
    ...
    <?php elseif (LicenseUtility::isProfessional()): ?>
            <table>
                <tr>
                    ...
                    <td valign="top" align="left" style="padding-left: 20px;">
                        <span style="font-size: 22px; font-weight: bold;">
                        You are a registered GidiJobs Professional user
                        </span>
                        <br /><br />
                        <span style="font-size: 14px; color: #000000;">
                        ...
                        Professional account, visit our GidiJobs Professional website at
                        <a href="http://www.gidijobs.co/professional">http://www.gidijobs.co/<b>professional</b></a>.
                        </span>
                        <p />
                        <b>Registered to:</b>
                        <br />
            ...
            <table cellspacing="15">
                <tr>
                    <td width="50%" valign="top">
                        ...
                        Need to renew or upgrade your licenses? Visit our official <a href="" target="_blank">Professional</a>
                    ...
                    <td width="50%" valign="top">
                        ...
                        <div style="font-size: 12px; color: #000000; text-align: justify;">
                        For more information on getting started and your Professional membership, please visit the official
                        Professional membership website at <a href="" target="_blank"><b>Professional</b></a>.
                        From there, you'll find information about the latest new releases and all the tools and resources
                        available to you.
                        </div>
                    </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" align="left" valign="top">
                                <div style="width: 100%; padding: 5px; background-color: #E7F1FC; font-size: 14px;">
                                    ...
                                    <br />
                                    <span style="font-size: 12px; line-height: 14px; color: #666666;">
                                    Run GidiJobs on your server. We'll support and manage it, keeping it up to date
                        ...
                        <tr>
                            <td width="50%" valign="top" align="left" style="padding-right: 20px; padding-bottom: 10px;">
                                <div style="width: 100%; padding: 5px; background-color: #D5E4F6; font-size: 14px;">
                                    ...
                                    <br />
                                    <span style="font-size: 12px; line-height: 14px; color: #666666;">
                                    Turn any ordinary computer into a GidiJobs server with our optional CD-ROM installer.
                            ...
                            <td width="50%" align="left" valign="top">
                                <div style="width: 100%; padding: 5px; background-color: #E7F1FC; font-size: 14px;">
                                    ...
                                    <br />
                                    <span style="font-size: 12px; line-height: 14px; color: #666666;">
                                    Purchase an optional custom server pre-loaded with GidiJobs Professinal. Just plug it
                                    into your network. GidiJobs is already installed!
                                    </span>
                                </div>
                            </td>
                        </tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="830">
                <tr>
                    ...
                    <td align="right" valign="bottom">
                        <a href="https://www.gidijobs.co/professional/">
            ...
            <tr>
                ...
                <td width="33%" align="center" valign="bottom">
                    <div style="width: 280px;">
                        <center>
                        <a href="http://www.gidijobs.co/?a=addons">
                ...
                <td width="33%" align="center" valign="bottom">
                    ...
                    <br />
                    <div style="width: 240px; text-align: left; font-size: 13px; font-weight: bold;">
                        Setup is included. We'll install and support GidiJobs for you.
                    </div>
                </td>
            </tr>
        </table>
            ...
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="left" valign="top" colspan="2" style="font-size: 22px; font-weight: bold;">
                        Activate GidiJobs Professional
                        <br />
                        <span style="font-size: 13px; font-weight: normal; line-height: 18px;">
                        Need a license key? Go to the GidiJobs Professional website at <a href="http://www.gidijobs.co/professional" target="_blank">
                        http://www.gidijobs.co/professional</a> to get one. Once you enter your key, all the features
                        available to GidiJobs Professional users will become available to you -- immediately.
                        </span>
                        <br /><br />
                    </td>
                </tr>
