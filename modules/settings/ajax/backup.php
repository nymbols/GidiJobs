...
if ($action == 'start')
{
    ...
    if ($attachmentsOnly)
    {
        $title = 'GidiJobs Attachments Backup';
    }
    else
    {
        $title = 'GidiJobs Backup';
    }
...
if ($action == 'backup')
{
    ...
    if (!$attachmentsOnly)
    {
         ...
         * schema and special GidiJobs restore files split into ~1MB chunks.
         */
        ...
        /* Add the GidiJobs restore files to the zip file. */
        ...
        markCompleted('Compressing database for GidiJobs restore...');
    }
