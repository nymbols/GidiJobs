...
<?php TemplateUtility::printHeaderBlock(); ?>
    ...
    <?php foreach ($this->submissionJobOrdersRS as $rowNumber => $submissionJobOrdersData): ?>
        <span style="font: normal normal bold 13px/130% Helvetica Neue, Helvetica, sans-serif;"><?php $this->_($submissionJobOrdersData['title']) ?> at <?php $this->_($submissionJobOrdersData['companyName']) ?> (<?php $this->_($submissionJobOrdersData['ownerFullName']) ?>)</span>
        <br />
