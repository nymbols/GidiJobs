...
<?php TemplateUtility::printHeaderBlock(); ?>
    ...
    <?php foreach ($this->placementsJobOrdersRS as $rowNumber => $placementsJobOrdersData): ?>
        <span style="font: normal normal bold 13px/130% Helvetica Neue, Helvetica, sans-serif;"><?php $this->_($placementsJobOrdersData['title']) ?> at <?php $this->_($placementsJobOrdersData['companyName']) ?> (<?php $this->_($placementsJobOrdersData['ownerFullName']) ?>)</span>
        <br />
