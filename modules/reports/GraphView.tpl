...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body style="background: #fff;">
        <div class="outer">
            ...
            <p id="footerText" align="center">GidiJobs Version <?php echo(CATSUtility::getVersion()); ?> build <?php echo(CATSUtility::getBuild()); ?>. <a href=""><strong></strong></a>.<br />
            <span id="footerCopyright">&copy;2017 GidiJobs Technologies, Inc. All rights reserved.</span></p>
        </div>
    </body>
</html>
