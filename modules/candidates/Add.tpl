                    ...
                    <tr>
                        ...
                        <td rowspan="12" align="center" valign="top">
                            ...
                            <?php else: ?>
                                ...
                                <a href="" target="_blank">All daily resume imports used. For more, upgrade to GidiJobs professional</a>.
                                <?php endif; ?>
                            ...
                            <?php if ($this->associatedAttachment == 0): ?>
                                <nobr> <?php /* FIXME:  remove nobr stuff */ ?>
                                    <?php if (isset($this->overAttachmentQuota)): ?>
                                        <span style="font-size:10px;">(You have already reached your limit of <?php echo(FREE_ACCOUNT_SIZE/1024); ?> MB of attachments, and cannot add additional file attachments without upgrading to GidiJobs Professional Hosted.)<br /></font>Copy and Paste Resume:&nbsp;
                                    <?php else: ?>
