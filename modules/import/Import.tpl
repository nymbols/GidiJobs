        ...
        <div id="contents">
            ...
            <?php else: ?>
                ...
                <table class="searchTable" id="importTable1" width="100%">
                    <tr>
                        <td>GidiJobs may discard or fail to read some of the submitted data which it does not
            ...
            <table class="searchTable" id="importHide6">
                <tr>
                    <td>
                        ...
                        If you wish, GidiJobs can create the companies for each company who is not in the database. The
                        ...
                        Smith is listed as having work address '1234 Fun St.', then GidiJobs can create the company Fun
                        ...
                        <span class="bold">Should GidiJobs generate the company data automatically?</span><br />
                        ...
                        <br />
                        <span class="bold">If there is no name for the companies contact, should GidiJobs name the contact 'nobody' and add it to the company?</span><br />
