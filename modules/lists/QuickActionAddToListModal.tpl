...
<?php TemplateUtility::printModalHeader('Candidates', array('js/lists.js'), 'Add to '.$this->dataItemDesc.' Static Lists'); ?>
    <table>
        <tr>
            ...
            <div style="display:none; font: normal normal normal 12px/130% Helvetica Neue, Helvetica, sans-serif;" id="addingToListAjaxing">
            ...
            <div style="display:none; font: normal normal normal 12px/130% Helvetica Neue, Helvetica, sans-serif;" id="addingToListAjaxingComplete">
