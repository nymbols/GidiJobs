...
/*
 * GidiJobs
 * GidiJobs WebTestCase Extension for SimpleTest
 *
*
 * All rights reserved.
 *
...
class CATSWebTestCase extends WebTestCase
{
    ...
    public function login()
    {
        ...
        $initialConfiguration = preg_match(
            '/<title>GidiJobs - Initial Configuration Wizard<\/title>/', $rawHTML
        );
        if ($initialConfiguration)
        {
            ...
            $this->assertClickSubmit('Continue Using GidiJobs');
        }
    ...
    {
        $message = sprintf(
            $message, "GidiJobs fatal errors should occur -- %s"
        );
    ...
    {
        $message = sprintf(
            $message, "No GidiJobs fatal errors should occur -- %s"
        );
        return $this->assertNoPattern(
            '/A fatal error has occurred./i',
            $message
