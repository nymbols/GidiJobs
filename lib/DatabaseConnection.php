    ...
    public function connect()
    {
        ...
        if (!$this->_connection)
        {
            ...
            die(
                ...
                . 'Helvetica Neue, Helvetica, sans-serif;">Error Connecting '
                . "to Database</p><pre>\n\n" . $error . "</pre>\n\n"
            );
            return false;
        }
        ...
        if (!$isDBSelected)
        {
            ...
            die(
                ...
                . '12px/130% Helvetica Neue, Helvetica, sans-serif;">Error Selecting '
                . "Database</p><pre>\n\n" . $error . "</pre>\n\n"
            );
            return false;
        }
    ...
    public function query($query, $ignoreErrors = false)
    {
        ...
        if (!$this->_queryResult && !$ignoreErrors)
        {
            ...
            echo (
                '<!-- NOSPACEFILTER --><p style="background: #ec3737; padding:'
                . ' 4px; margin-top: 0; font: normal normal bold 12px/130%'
                . ' Helvetica Neue, Helvetica, sans-serif;">Query Error -- Report to System'
