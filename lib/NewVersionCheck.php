...
class NewVersionCheck
{
    ...
    /**
     * Checks remote server for a new version of GidiJobs.  Also submits
    ...
    public static function checkForUpdate()
    {
        ...
        /* Hack for compatability with older GidiJobs versions. */
        $postData .= '&CatsVersionAgain=' . urlencode($catsVersion);

        $theData = self::getDataFromServer(
            'www.gidijobs.co', 80, '/catsnewversion.php', $postData
        );
