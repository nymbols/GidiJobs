    ...
    public static function fatal($code, $active, $customMessage = '', $modal = false)
    {
        ...
        switch ($code)
        {
            case COMMONERROR_RESTRICTEDEXTENSION:
                ...
                $errorMessage = '<b>' . $customMessage . '</b><p />GidiJobs is free software and is available to anyone free '
            ...
            case COMMONERROR_RECORDERROR:
                ...
                $errorMessage = 'The internal mechanics GidiJobs uses to add and edit records like candidates, companies, job '
            ...
            case COMMONERROR_INVALIDMODULE:
                ...
                $errorMessage = 'The module you requested, "<b>' . htmlentities($customMessage) . '</b>", doesn\'t exist or we haven\'t created it yet!<p>'
                    . 'One of the most amazing things about GidiJobs is that through modules, you add new features '
            ...
            case COMMONERROR_FILEERROR:
                ...
                $errorMessage = 'There was a problem when GidiJobs attempted to process the file you selected. '
            ...
            case COMMONERROR_BADINDEX:
                ...
                $errorMessage = 'When you perform actions in GidiJobs like editting a candidate or a job order, '
                    ...
                    . 'attached to it. GidiJobs cannot find a record with the number you provided. The record '
                    . 'may have been deleted, you may have inadvertently logged off or an incorrect number '
                    . 'may have been provided to you.'
                    . '<br /><br />'
                    . '<b>It\'s ok!</b> GidiJobs can\'t complete whatever action you requested; but chances are, '
            ...
            case COMMONERROR_NOTLOGGEDIN:
                ...
                $errorMessage = 'You followed a link from an account logged into GidiJobs but are no longer logged '
                    . 'in and GidiJobs cannot allow you to continue. <b>It\'s Ok!</b> This sort of thing can happen '
                    . 'if you have GidiJobs open in another window and log off from that window, if you timeout and your '
