...
class TemplateUtility
{
    ...
    public static function printHeaderBlock($showTopRight = true)
    {
        ...
        echo '<tr>', "\n";
        echo '<td rowspan="2"><img src="images/applicationLogo.jpg" border="0" alt="CATS Recruitement Portal" /></td>', "\n";
        echo '</tr>', "\n";
        echo '</table>', "\n";
        ...
        if ($showTopRight)
        {
            ...
            if (isset($systemInfoData['available_version']) &&
                ...
                $_SESSION['CATS']->getAccessLevel(ACL::SECOBJ_ROOT) >= ACCESS_LEVEL_SA)
            {
                echo '<a href="" target="catsdl">A new version is available!</a><br />';
            }
    ...
    public static function printFooter()
    {
        ...
        echo '<p id="footerText">GidiJobs Version ', CATS_VERSION, $buildString,
             '. <span id="toolbarVersion"></span>Powered by GidiJobs.</p>', "\n";
    ...
    public static function printReportFooter()
    {
        ...
        echo 'GidiJobs Version ', CATS_VERSION, $buildString,
             '. Powered by GidiJobs.</p>', "\n";
        echo '<span id="footerCopyright">', COPYRIGHT_HTML, '</span>', "\n";
        echo '</div>', "\n";
    ...
    private static function _printCommonHeader($pageTitle, $headIncludes = array())
    {
        ...
        echo '<head>', "\n";
        echo '<title>GidiJobs - ', $pageTitle, '</title>', "\n";
