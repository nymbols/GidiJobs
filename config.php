...
define('DATABASE_USER', 'gidijobs');
define('DATABASE_PASS', 'gidijobspass');
define('DATABASE_HOST', 'localhost');
define('DATABASE_NAME', 'gidijobs');
 ...
 */
define('MAIL_SMTP_HOST', "smtp.mail.yahoo.com");
define('MAIL_SMTP_PORT', 587);
define('MAIL_SMTP_AUTH', true);
define('MAIL_SMTP_USER', "dewnigga@yahoo.com");
define('MAIL_SMTP_PASS', "nym1yahoo");
//Options: '', 'ssl' or 'tls'
