...
INSERT INTO dashboard_component SELECT NULL, 'html', '\"<a href=\"\"http://www.gidijobs.co/forum/\"\" target=newwin1> CATS Forums</a><br />\r\n<a href=\"\"http://www.cognizo.com\"\" target=newwin2>GidiJobs Labs</a>\"', site_id, 1, 2 FROM site;
...
INSERT INTO dashboard_component SELECT NULL, 'titleBar', '\"Welcome!\"', site_id, 0, 0 FROM site;
INSERT INTO dashboard_component SELECT NULL, 'html', '\"<a href=\"\"http://www.gidijobs.co/forum/\"\" target=newwin1> CATS Forums</a><br />\r\n<a href=\"\"http://www.cognizo.com\"\" target=newwin2>GidiJobs Labs</a>\"', site_id, 0, 4 FROM site;
