...
<html>
    <head>
        <title>GidiJobs - Installation Wizard Script</title>
                                ...
                                <tr>
                                    <td style="vertical-align: top; text-align: left;" id="allSpans">
                                        <div id="installLocked" style="display: none;">
                                            <span style="font-weight: bold;">GidiJobs is already installed!</span><br />
                                            <p>To run the installer again, you must first delete the file named INSTALL_BLOCK in the GidiJobs directory. After removing the file, you can click &quot;Retry Installation&quot; below.</p><br />
                                        ...
                                        <div id="startInstall" style="display: none;">
                                            <span style="font: normal normal bold 18px Helvetica Neue, Helvetica, sans-serif">Welcome to GidiJobs!</span><br />

                                            <p style="text-align: justify; margin-top: 15px;">This process will help you set up the GidiJobs environment
                                            for the first time. Before we begin, GidiJobs needs to run some tests on your system to make sure that your
                                            web environment can support GidiJobs and is configured properly.</p>
                                        </div>
                                        <div id="phpVersion" style="display: none;">
                                            ...
                                            <tr class="fail"><td>PHP 5.0.0 or greater is required to run GidiJobs. Found version: <?php echo(phpversion()); ?>.</td></tr>
                                            </table>
                                        </div>
                                        <div id="databaseConnectivity" style="display: none;">
                                            <span style="font-weight: bold;">Database Configuration</span><br />
                                            <br />
                                            The GidiJobs installer needs some information about your MySQL database to continue the installation.
                                        ...
                                        <div id="resumeParsing" style="display: none;">
                                            ...
                                            <br />
                                            GidiJobs can index resumes for advanced searching with the assistance of external
                                            document processing software. You need to configure the software below
                                            to enable resume indexing.<br />
                                            <br />
                                            <a href="http://www.gidijobs.co/resumeIndexingSoftware.php?os=<?php echo(urlencode(PHP_OS)); ?>&amp;server_software=<?php echo(urlencode($_SERVER['SERVER_SOFTWARE'])); ?>" target="resumeParsingSoftwareDownload">
                                        ...
                                        <div id="mailSettings" style="display: none;">
                                            ...
                                            <br />
                                            Please enter your e-mail address (for where GidiJobs e-mails should be replied to, etc.).
                                            <br />
                                            <br />
                                            <table width="100%">
                                                <tr>
                                            ...
                                            <br />
                                            <br />
                                            GidiJobs sends automatic E-Mails on different events.  Please choose the mechanism for E-Mail delivery via GidiJobs.<br />
                                            <br />
                                            <form name="mailForm">
                                            <table width="100%">
                                                <tr>
                                        ...
                                        <div id="installingComponentsMaint" style="display: none;">
                                            ...
                                            <br />
                                            Please wait whilst the GidiJobs database is brought up to date...<br />
											<br />
                                        ...
                                        <div id="emptyDatabase" style="display: none;">
                                            ...
                                            <br />
                                            The installer is ready to set up your GidiJobs data. Please pick the way you want the installer to set up GidiJobs:<br />
                                            <br />
                                        ...
                                        <div id="unknownDataInDatabase" style="display: none;">
                                            ...
                                            <br />
                                            Please remove all of the-non GidiJobs tables to continue.<br />
                                            <br />
                                            <input type="button" class="button" value="Remove Non-GidiJobs Tables" onclick="Installpage_populate('a=resetDatabase');">&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div id="databaseUpgrade" style="display: none;">
                                            ...
                                            <br />
                                            The installer has scanned the database and found an older version of GidiJobs in the database (<span id="upgradeVersion"></span>). The installer
                                        ...
                                        <div id="catsUpToDate" style="display: none;">
                                            ...
                                            <br />
                                            The installer has detected an existing installation of GidiJobs.<br />
                                            How would you like to proceed?<br />
                                            <br />
                                            <input type="radio" name="installgroupexists" id="currentCheckBox" value="current" checked />&nbsp;Use existing GidiJobs installation and automatically preform any necessary upgrade (recommended).<br />
                                            <br />
                                            <input type="radio" name="installgroupexists" value="empty" />&nbsp;Delete existing data and create a new installation.<br />
                                            <input type="radio" name="installgroupexists" value="demo" />&nbsp;Delete existing data and install the GidiJobs demonstration database.<br />
                                            <input type="radio" name="installgroupexists" value="restore" />&nbsp;Delete existing data and restore a previous GidiJobs installation from backup.<br />
                                            <br />
                                            If you choose to use the existing GidiJobs installation, you can always run<br />
                                        ...
                                        <div id="queryInstallDemo" style="display: none;">
                                            ...
                                            <br />
                                            The database will be pre-populated with test data that you can use to train new users on using GidiJobs. You can login using
                                        ...
                                        <div id="installCompleteProd" style="display: none;">
                                            ...
                                            <br />
                                            The installer has finished installing GidiJobs! The installer has been disabled to prevent unauthorized access. To run the installer again, delete the file 'INSTALL_BLOCK' in your GidiJobs directory.<br /><br />
                                            <br />
                                            You may now login to GidiJobs. If it is a new installation, use the following logon information:<br /><br />
                                            Username: admin<br />
                                            Password: admin<br />
                                            <br />
                                            <br />
                                            GidiJobs will periodically check for new versions of the software from catsone.com, and will send non confidential information about your
                                            installation including operating system version and web browser configuration back to catsone.com in order for us to improve GidiJobs.  To see what information is sent, view
                                            lib/NewVersionCheck.php.<br />
                                            <br />
                                            <input type="button" class="button" value="Start GidiJobs" onclick="window.location.href='index.php';" />
                                        </div>
                                        <div id="installCompleteDemo" style="display: none;">
                                            ...
                                            The installer has finished installing GidiJobs! The installer has been disabled to prevent unauthorized access. To run the installer again, delete the file 'INSTALL_BLOCK' in your GidiJobs directory.<br /><br />
                                            <br />
                                            You may now login to GidiJobs. To login, either click "Login to Demo Account" on the logon screen or use the following logon information:<br /><br />
                                        ...
                                        <div id="pickOptionalComponents" style="display:none;">
                                            ...
                                            <br />
                                            GidiJobs comes with some optional features. You can enable them below.<br />
                                            <br />
                                        ...
                                        <span id="subFormBlock" style="font: normal normal normal 9pt Helvetica Neue, Helvetica, sans-serif;"></span>
                                        ...
                                        <div id="testWarning" style="display: none;">
                                            ...
                                            <br />
                                            If you have any questions, visit the GidiJobs forums at <a href="http://www.opencats.org/forums/">http://www.opencats.org/forums/</a>.</td></tr></table><br />
                                            <input style="float: right;" type="button" class="button" value="Next -->" onclick="Installpage_populate('a=databaseConnectivity');" />
                                        </div>
                                        ...
                                        <div id="testFailedWarning" style="display: none;"><table class="footer_warning"><tr><td>One or more tests issued a warning. You may still proceed, but read the warnings carefully and address them if you can.<br />
                                            <br />
                                            If you have any questions, visit the GidiJobs forums at <a href="http://www.opencats.org/forums/">http://www.opencats.org/forums/</a>.</td></tr></table>
