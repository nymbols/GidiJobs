...
/* GidiJobs Version */
define('CATS_VERSION', '0.1.0 GidiJobs');

/* Copyright information at bottom of pages. */
define('COPYRIGHT_HTML', '&copy; 2017 GidiJobs Labs, Inc.');
...
/* Site ID under which to store  GidiJobs system administrative data, etc. */
